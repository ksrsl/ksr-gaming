...
const games: Game[] = [
  ...
  { id: "polytrack", name: "PolyTrack", genre: "Racing", engine: "HTML5", multiplayer: false, cover: "./games/PolyTrackCoverArt500.webp", thumb: "./games/thumbs/PolyTrack.webp", background: "./games/PolyTrack.webp", iframe: "https://games.crazygames.com/en_US/polytrack/index.html", description: "Chase perfect racing lines across fast low-poly tracks built for instant restarts.", controls: "WASD" },
  { id: "sniper-clash-3d", name: "Sniper Clash 3D", genre: "Shooter", engine: "HTML5", multiplayer: false, cover: "./games/SniperClash3DCoverArt500.webp", thumb: "./games/thumbs/SniperClash3D.webp", background: "./games/SniperClash3D.webp", iframe: "https://games.crazygames.com/en_US/sniper-clash-3d/index.html", description: "Capture the flag in a focused third-person arena built around movement and precision.", controls: "WASD · MOUSE · LEFT CLICK" },
  { id: "subway-clash-2", name: "Subway Clash 2", genre: "Shooter", engine: "HTML5", multiplayer: false, cover: "./games/SubwayClash2CoverArt500.webp", thumb: "./games/thumbs/SubwayClash2.webp", background: "./games/SubwayClash2.webp", iframe: "https://games.crazygames.com/en_US/subway-clash-2/index.html", description: "Fight fast third-person battles through an atmospheric abandoned subway.", controls: "WASD · MOUSE · LEFT CLICK" },
