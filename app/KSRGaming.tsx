...
const games: Game[] = [
  ...
  { id: "highway-racer", name: "Highway Racer", genre: "Racing", engine: "Unity", multiplayer: false, cover: "./games/HighwayRacerCoverArt500.webp", thumb: "./games/thumbs/HighwayRacer.webp", background: "./games/HighwayRacer.webp", iframe: "https://games.crazygames.com/en_US/highway-racer/index.html", description: "Thread through fast highway traffic, earn near-miss bonuses and upgrade your favorite cars.", controls: "W / UP · A D / ARROWS · SPACE" },
  { id: "space-waves", name: "Space Waves", genre: "Arcade", engine: "Unity", multiplayer: false, cover: "./games/SpaceWavesCoverArt500.webp", thumb: "./games/thumbs/SpaceWaves.webp", background: "./games/SpaceWaves.webp", iframe: "https://games.crazygames.com/en_US/space-waves/index.html", description: "Guide a neon arrow through precision obstacle courses with responsive one-button control.", controls: "LEFT CLICK · W · SPACE" },
  { id: "basket-random", name: "Basket Random", genre: "Sports", engine: "HTML5", multiplayer: true, cover: "./games/BasketRandomCoverArt500.webp", thumb: "./games/thumbs/BasketRandom.webp", background: "./games/BasketRandom.webp", iframe: "https://games.crazygames.com/en_US/basket-random/index.html", description: "Play unpredictable physics basketball solo or with a friend using a single key per team.", controls: "W · UP ARROW" },
  { id: "noob-zombie-shooting", name: "NOOB: Zombie Shooting", genre: "Arcade", engine: "HTML5", multiplayer: false, cover: "./games/NoobZombieShootingCoverArt500.webp", thumb: "./games/thumbs/NoobZombieShooting.webp", background: "./games/NoobZombieShooting.webp", iframe: "https://games.crazygames.com/en_US/noob-zombie-shooting/index.html", description: "Survive colorful zombie waves with immediate arcade movement and shooting.", controls: "WASD · MOUSE · LEFT CLICK" },
  { id: "brawl-hero", name: "Brawl Hero", genre: "Action", engine: "HTML5", multiplayer: false, cover: "./games/BrawlHeroCoverArt500.webp", thumb: "./games/thumbs/BrawlHero.webp", background: "./games/BrawlHero.webp", iframe: "https://games.crazygames.com/en_US/brawl-hero/index.html", description: "Dodge enemy attacks, collect upgrades and clear compact action arenas.", controls: "WASD · LEFT CLICK" },
  { id: "moto-x3m-spooky-land", name: "Moto X3M: Spooky Land", genre: "Racing", engine: "HTML5", multiplayer: false, cover: "./games/MotoX3MSpookyLandCoverArt500.webp", thumb: "./games/thumbs/MotoX3MSpookyLand.webp", background: "./games/MotoX3MSpookyLand.webp", iframe: "https://games.crazygames.com/en_US/moto-x3m-spooky-land/index.html", description: "Race, flip and land through cinematic obstacle courses with simple controls.", controls: "WASD" },
];
